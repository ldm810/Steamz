...
class RegistrationForm(UserCreationForm):
    ...
    SCHOOL_CHOICES = (('University of North Carolina Chapel Hill','University of North Carolina Chapel Hill'),('Duke University','Duke University'))
    school = forms.ChoiceField(widget=forms.RadioSelect,choices=SCHOOL_CHOICES)
    ...
    def save(self,commit = True):   
        ...
        potential_matches = Profile.objects.filter(gender=user.preference).filter(preference=user.gender).exclude(user=user).filter(school=user.school)
